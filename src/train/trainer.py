...
class SupervisedTrainer(object):
    def __init__(self, expt_dir='experiment', loss = NLLLoss(), batch_size=64, random+seed=None, checkpoint_every=500, print_every=1000):
    ...
    def _train_epoches(self, data, model, n_epochs, start_epoch, start_step, dev_data=None, teacher_forcing_ratio=0):
        ...
        batch_iterator = torchtext.data.BucketIterator(
                ...
                sort=False, sort_withing_batch=True,
